...
<div class="text-center p-3" style="background-color: rgba(255, 255, 255, 0.05);">
    All Rights Reserved © <span id="year"></span> Copyright
    <a class="text-reset fw-bold" href="#">.....</a> Develop/Design by <a class="text-reset fw-bold" href="shubhammaurya.vercel.app">MD. TAHMID - (01727452728)</a>
</div>
<!-- Copyright -->
</footer>
